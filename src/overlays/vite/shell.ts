...
export function getIndexHtmlTemplate(projectName: string, rtl: boolean): string {
  const description = `Starter app generated by Forge for ${projectName}.`;
  const ogLocaleTags = rtl
...
${ogLocaleTags}    <meta property="og:title" content="${projectName}" />
